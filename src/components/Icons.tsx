...
export const BookOpenIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M11.25 4.533A9.707 9.707 0 006 3.75a9.706 9.706 0 00-6 3.75V16.5a9.706 9.706 0 016-3.75h.75a9.706 9.706 0 016 3.75V4.533zM12.75 4.533A9.707 9.707 0 0118 3.75a9.706 9.706 0 016 3.75V16.5a9.706 9.706 0 00-6-3.75h-.75a9.706 9.706 0 00-6 3.75V4.533z" />
  </svg>
);
